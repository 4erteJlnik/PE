...
namespace Web1.Services
{
    public class CommentService:ICommentService
    {
        ...
        public void Add(PostComment comment)
        {
            ...
            {
                throw new Exception("Обьявление не найдено" + postComment.PostId.ToString());
            }
            ...
            {
                throw new Exception("Пользователь не найден" + postComment.UserId.ToString());
            }
        ...
        public PostComment GetById(Guid id)
        {
            ...
            if (comment == null)
                throw new Exception("Не найдено " + id.ToString());
