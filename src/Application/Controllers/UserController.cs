...
{ 
    ...
    public class UserController : Controller
    {
        ...
        public UserController(UserManager<Peoplelogin> userManager, PeopleService peopleService)
        {
        ...
        public async Task<IActionResult> Edit(Peoplelogin model)
        {
            if (ModelState.IsValid)
            {
                Peoplelogin user = await _userManager.FindByIdAsync(model.Id.ToString());
                if (user != null)
                {
