...
{
    public class CustomPasswordValidator : IPasswordValidator<Peoplelogin>
    {
        ...
        public Task<IdentityResult> ValidateAsync(UserManager<Peoplelogin> manager, Peoplelogin user, string password)
        {
